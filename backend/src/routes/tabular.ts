...
import {
    extractPdfMarkdown as extractPdfMarkdownShared,
    extractDocxMarkdown as extractDocxMarkdownShared,
...
const extractPdfMarkdown = extractPdfMarkdownShared;
const extractDocxMarkdown = extractDocxMarkdownShared;
