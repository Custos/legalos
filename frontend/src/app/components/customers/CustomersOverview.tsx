            ...
            <div className="px-8 pb-2 text-xs text-gray-500">
                {loading
                    ...
                    : `${filtered.length} ${
                      ...
                      } · ${filtered.reduce((acc, g) => acc + g.document_count, 0)} documents`}
            </div>
                        ...
                        {filtered.map((g) => (
                            ...
                            >
                                ...
                                <div className="bg-gray-50/50 border-t border-gray-100">
                                    <button
                                        onClick={() =>
                                            router.push(`/parties/${g.slug}`)
                                        }
                                        className="w-full flex items-center justify-between px-10 py-2 text-left text-xs text-blue-700 hover:bg-blue-50 transition-colors"
                                    >
                                        <span>
                                            View timeline ({g.document_count}{" "}
                                            {g.document_count === 1
                                                ? "document"
                                                : "documents"}) →
                                        </span>
                                    ...
                                    {g.projects
                                        ...
                                        .map((p) => (
                                            <button
                                                ...
                                                className="w-full flex items-center justify-between px-10 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 transition-colors border-t border-gray-100"
                                            >
